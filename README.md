...
1. Download **[HyPad-win_x64.zip](https://github.com/Miftahul-Islam-Efaz/HyPad/releases/latest/download/HyPad-win_x64.zip)** (1.3 MB) from the `download` folder, or from [Releases](../../releases).
